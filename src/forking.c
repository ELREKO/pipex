...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/18 11:14:00 by rkost             #+#    #+#             */
/*   Updated: 2023/11/18 11:29:46 by rkost            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/pipex.h"

static	void	ft_cmd_handle(char **cmd, char *input_file, char *output_file,
					t_arg **list);
...
* @param open_close it is a int value '1' is put in one end / 
* 		'0' get it from the other end od the pipe
*/
static	void	ft_pipe_setting(int *pipfd, int open_close, t_arg **list)
{
	if (open_close == 1)
